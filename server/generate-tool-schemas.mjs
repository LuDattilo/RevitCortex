 ...
 * Output: ../tool-schemas.txt (project root) — compact one-line-per-tool format
 * that saves tokens when included in CLAUDE.md or system prompts.
 *
 * Usage: node server/generate-tool-schemas.mjs
 */
